...
baseDir= '../../';
codeDir = [baseDir,filesep,'codes', filesep];
...
CFGPath=[baseDir,filesep,'tools',filesep,'htk_features', filesep];
addpath(CFGPath);
...
eI.DataPath = [baseDir,filesep,'codes',filesep,'TSP', filesep,'Data',filesep];
% eI.seqLen = [1];
